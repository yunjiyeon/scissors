...
function App() {
  const [userSelect, setUseSelect] = useState (); /* useState (null) 첫 화면은 비워놔도 되고 null 입력도 가능*/
  ...
  /* 삼항 연산자 */
    ...
    if (uc.name == cc.name){
      return 'Tie😨';
    } else if ( uc.name == 'Rock') return cc.name == 'Scissors' ? 'Win😎' : 'Lose😭';
    else if ( uc.name == 'Scissors') return cc.name == 'Paper' ? 'Win😎' : 'Lose😭';
